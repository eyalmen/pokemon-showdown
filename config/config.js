...
exports.ssl = {
	port: 443,
	options: {
		key : fs.readFileSync('/home/opc/pokemon-showdown-0.11.7/config/ssl/privkey.pem', 'utf8'),
                cert: fs.readFileSync('/home/opc/pokemon-showdown-0.11.7/config/ssl/fullchain.pem', 'utf8'),
     },
};
*/
...
exports.loginserver = 'http://play.pseudo.gq/';
exports.loginserverkeyalgo = "RSA-SHA1";
exports.loginserverpublickeyid = 4;
exports.loginserverpublickey = `-----BEGIN PUBLIC KEY-----

-----END PUBLIC KEY-----
`;

/*
 * Not sure where to put this, but it's for the login server.
 * comment it out when switching back to the reg login server.
*/
exports.serverid = 'pseudos';
exports.servertoken = '18ca22d87d511bd7bb29c5e463f681be';
 ...
 */
 exports.routes = {
	...
	client: 'play.pseudo.gq',
	dex: 'dex.pokemonshowdown.com',
	replays: 'hehe.pseudo.gq',
};
 ...
 */
exports.consoleips = ['127.0.0.1', '102.39.239.70', 'madamadam2', 'madamadam', 'adam'];
...
exports.customavatars = {
	...
	'madamadam2': 'cynthia_victini.png',
	'wailord': 'wailord.gif',
	'adam': 'wailord.gif',
};
